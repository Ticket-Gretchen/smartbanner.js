 ...
 * Copyright © 2025 Ain Tohvri, contributors. Licensed under GPL-3.0.
 */
...
var SmartBanner = exports["default"] = /*#__PURE__*/function () {
  ...
  return _createClass(SmartBanner, [{
    ...
    get: function get() {
      ...
      var position = this.options.position || 'top';
      return "<div class=\"smartbanner smartbanner--".concat(position, " smartbanner--").concat(modifier, " js_smartbanner \">\n      <span class=\"smartbanner__exit js_smartbanner__exit\" aria-label=\"").concat(this.closeLabel, "\"></span>\n      <div class=\"smartbanner__icon\" style=\"background-image: url(").concat(this.icon, ");\"></div>\n      <div class=\"smartbanner__info\">\n        <div>\n          <div class=\"smartbanner__info__title\">").concat(this.options.title, "</div>\n          <div class=\"smartbanner__info__author\">").concat(this.options.author, "</div>\n          <div class=\"smartbanner__info__price\">").concat(this.price).concat(this.priceSuffix, "</div>\n        </div>\n      </div>\n      <a href=\"").concat(this.buttonUrl, "\" target=\"_blank\" class=\"smartbanner__button js_smartbanner__button\" rel=\"noopener\" aria-label=\"").concat(this.buttonLabel, "\"><span class=\"smartbanner__button__label\">").concat(this.buttonLabel, "</span></a>\n    </div>");
    }
  }, {
    key: "height",
    get: function get() {
